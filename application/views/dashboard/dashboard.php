        ...
        <div class="box box-widget widget-user">
            <div class="widget-user-header bg-blue-active">
                <p style="text-align: center;">
                    <span style="font-family: georgia, palatino; font-size: 15pt;">Selamat datang di Sistem Absensi Pesantren</span>
                </p>
            ...
            <div class="box-footer">
                <div class="row">
                    ...
                    <div class="col-sm-4 border-right">
                        ...
                        <center>
                            <i>Sistem Absensi Pesantren berbasis QR CODE</i><br>
